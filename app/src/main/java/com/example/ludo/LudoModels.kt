...
enum class LudoPlayerColor(
    ...
    Yellow("الأصفر", startCell = 9, argb = 0xFFFFBE0B),
    Blue("الأزرق", startCell = 22, argb = 0xFF3A86FF),
    Red("الأحمر", startCell = 35, argb = 0xFFE84855),
    Green("الأخضر", startCell = 47, argb = 0xFF2A9D8F),
}
